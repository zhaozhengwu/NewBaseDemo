 ...
 * data：17/01/18
 */
public class PictureExternalPreviewCustomActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    private static OnImageLongClickListener mOnImageLongClickListener;
    ...
    public static void setOnImageLongClickListener(OnImageLongClickListener onImageLongClickListener) {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (media != null) {
                ...
                if (isGif && !media.isCompressed()) {
                    ...
                    Glide.with(PictureExternalPreviewCustomActivity.this)
                            .asGif()
                            .apply(gifOptions)
                            .load(path)
                ...
                imageView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        if (rxPermissions == null) {
                            rxPermissions = new RxPermissions(PictureExternalPreviewCustomActivity.this);
                        }
    ...
    private void showDownLoadDialog(final String path) {
        if (mOnImageLongClickListener != null) {
            mOnImageLongClickListener.OnImageLongClick(this);
        } else {
            final CustomDialog dialog = new CustomDialog(PictureExternalPreviewCustomActivity.this,
                    ScreenUtils.getScreenWidth(PictureExternalPreviewCustomActivity.this) * 3 / 4,
                    ScreenUtils.getScreenHeight(PictureExternalPreviewCustomActivity.this) / 4,
                    R.layout.custom_picture_wind_base_dialog_xml, R.style.Theme_dialog);
            ...
            btn_commit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (isHttp) {
                        ...
                        // 有可能本地图片
                        try {
                            String dirPath = PictureFileUtils.createDir(PictureExternalPreviewCustomActivity.this,
    ...
    public void showLoadingImage(String urlPath) {
        try {
            ...
            String path = PictureFileUtils.createDir(PictureExternalPreviewCustomActivity.this,
                    System.currentTimeMillis() + ".png", directory_path);
