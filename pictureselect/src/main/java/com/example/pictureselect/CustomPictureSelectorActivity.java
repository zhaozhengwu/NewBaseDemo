 ...
 * @描述: Media 选择页面
 */
public class CustomPictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private final static String TAG = CustomPictureSelectorActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config.camera) {
                        ...
                        .subscribe(new Observer<Boolean>() {
                            ...
                            public void onNext(Boolean aBoolean) {
                                if (aBoolean) {
                                    ...
                                    ToastManage.s(mContext, getString(com.luck.picture.lib.R.string.picture_camera));
                                    closeActivity();
                                }
                            }
            ...
            setContentView(R.layout.custom_picture_empty);
        } else {
            setContentView(R.layout.custom_picture_selector);
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        String title = config.mimeType == PictureMimeType.ofAudio() ?
                getString(com.luck.picture.lib.R.string.picture_all_audio)
                : getString(com.luck.picture.lib.R.string.picture_camera_roll);
        ...
        tv_empty.setText(config.mimeType == PictureMimeType.ofAudio() ?
                getString(com.luck.picture.lib.R.string.picture_audio_empty)
                : getString(com.luck.picture.lib.R.string.picture_empty));
        ...
        adapter.setOnPhotoSelectChangedListener(CustomPictureSelectorActivity.this);
    ...
    private void isNumComplete(boolean numComplete) {
        picture_tv_ok.setText(numComplete ? getString(com.luck.picture.lib.R.string.picture_done_front_num,
                0, config.selectionMode == PictureConfig.SINGLE ? 1 : config.maxSelectNum)
                : getString(com.luck.picture.lib.R.string.picture_please_select));
        if (!numComplete) {
            animation = AnimationUtils.loadAnimation(this, com.luck.picture.lib.R.anim.modal_in);
        }
        animation = numComplete ? null : AnimationUtils.loadAnimation(this, com.luck.picture.lib.R.anim.modal_in);
    }
        ...
        rxPermissions.request(Manifest.permission.RECORD_AUDIO).subscribe(new Observer<Boolean>() {
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    ...
                    ToastManage.s(mContext, getString(com.luck.picture.lib.R.string.picture_audio));
                }
            }
        ...
        if (id == R.id.id_ll_ok) {
            ...
            if (config.minSelectNum > 0 && config.selectionMode == PictureConfig.MULTIPLE) {
                if (size < config.minSelectNum) {
                    String str = eqImg ? getString(com.luck.picture.lib.R.string.picture_min_img_num, config.minSelectNum)
                            : getString(com.luck.picture.lib.R.string.picture_min_video_num, config.minSelectNum);
    ...
    private void audioDialog(final String path) {
        audioDialog = new CustomDialog(mContext,
                ...
                ,
                com.luck.picture.lib.R.layout.picture_audio_dialog, com.luck.picture.lib.R.style.Theme_dialog);
        audioDialog.getWindow().setWindowAnimations(com.luck.picture.lib.R.style.Dialog_Audio_StyleAnim);
        tv_musicStatus = (TextView) audioDialog.findViewById(com.luck.picture.lib.R.id.tv_musicStatus);
        tv_musicTime = (TextView) audioDialog.findViewById(com.luck.picture.lib.R.id.tv_musicTime);
        musicSeekBar = (SeekBar) audioDialog.findViewById(com.luck.picture.lib.R.id.musicSeekBar);
        tv_musicTotal = (TextView) audioDialog.findViewById(com.luck.picture.lib.R.id.tv_musicTotal);
        tv_PlayPause = (TextView) audioDialog.findViewById(com.luck.picture.lib.R.id.tv_PlayPause);
        tv_Stop = (TextView) audioDialog.findViewById(com.luck.picture.lib.R.id.tv_Stop);
        tv_Quit = (TextView) audioDialog.findViewById(com.luck.picture.lib.R.id.tv_Quit);
    ...
    public class audioOnClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            int id = v.getId();
            if (id == com.luck.picture.lib.R.id.tv_PlayPause) {
                playAudio();
            }
            if (id == com.luck.picture.lib.R.id.tv_Stop) {
            ...
            if (id == com.luck.picture.lib.R.id.tv_Quit) {
                handler.removeCallbacks(runnable);
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
        ...
        if (enable) {
            ...
            if (numComplete) {
                picture_tv_ok.setText(getString
                        (com.luck.picture.lib.R.string.picture_done_front_num, selectImages.size(),
                ...
                picture_tv_ok.setText(getString(com.luck.picture.lib.R.string.picture_completed));
                anim = false;
            }
        } else {
            ...
            if (numComplete) {
                picture_tv_ok.setText(getString(com.luck.picture.lib.R.string.picture_done_front_num, 0,
                        config.selectionMode == PictureConfig.SINGLE ? 1 : config.maxSelectNum));
            } else {
                picture_tv_img_num.setVisibility(View.INVISIBLE);
                picture_tv_ok.setText(getString(com.luck.picture.lib.R.string.picture_please_select));
            }
        }
    }
